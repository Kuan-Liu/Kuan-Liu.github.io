...
## 3. COVID-19 Testing Trend in Canada [(link)](https://rpubs.com/kuanstat/testing_can)
...
We are planning to move the website content to a new shiny app in June using primarily the official federal and provincial testing data. The current analysis uses mainly the testing data provided by [the COVID-19 Canada Open Data Working Group](https://github.com/ishaberry/Covid19Canada). 
